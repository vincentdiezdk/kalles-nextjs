          ...
          <div className="border-2 border-dashed border-primary/30 rounded-xl p-6 bg-primary/[0.03] flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h3 className="font-sans font-bold text-lg text-foreground">
                🏘️ Nabo-rabat — Spar penge sammen
              </h3>
            ...
            <Link href="/nabo-rabat">
              <Button variant="outline" className="shrink-0 font-semibold" data-testid="nabo-rabat-cta">
                Læs om nabo-rabat
              </Button>
            </Link>
          </div>
    ...
    <section className="py-6 bg-yellow-50 border-y border-yellow-200/50" data-testid="social-proof-banner">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center sm:text-left">
          ...
          <a href="https://www.google.com/maps/place/Kalles+Algerens+ApS/" target="_blank" rel="noopener noreferrer" className="text-xs font-medium text-primary hover:underline shrink-0">
            Find os på Google →
          </a>
        </div>
      </div>
